...
class ClashDiscord_Data(object):
    ...
    bot_categories = [
        ...
        ClashDiscord_Category("Discord", "discord", "Discord based commands", "💻"),
        ClashDiscord_Category("Announce", "announce", "Announce based commands", "📣"),
        ClashDiscord_Category("Player", "player", "Player based commands", "😎"),
        ClashDiscord_Category("Clan", "clan", "Clan based commands", "🏠"),
        ClashDiscord_Category("War", "war", "War based commands", "⚔️"),
        ClashDiscord_Category("CWL", "cwl", "CWL based commands", "🔱"),
    ]
